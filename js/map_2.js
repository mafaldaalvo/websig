// Mapa 24 de Janeiro por 10.000 Habitantes
...
info.update = function (props) {
    this._div.innerHTML = '<h4>24 de Janeiro<br>Casos por 10.000 habitantes</h4>' + (props ?
        '<b>' + props.Concelho + '</b><br />' + props.Casos_24_1 + ' casos / 10.000 hab.'
...
function style(feature) {
    return {
        ...
        fillColor: getColor(feature.properties.Casos_24_1)
    };
}
